...
const marqueeLogos = [
  "Gymshark", "Represent", "Kith", "Taylor Stitch", "Rare Beauty", "Burrow", "Article", "Nomad", "Bellroy", "Great Jones", "MVMT", "Mejuri", "The Million Roses", "Allbirds", "Fenty Beauty", "Brooklinen", "Wild One", "Heatonist"
];

const marqueeIndustries = [
  "Fashion & Apparel", "Beauty & Cosmetics", "Modular Furniture", "Tech Accessories", "Subscription Models", "B2B wholesale", "Checkout Extensibility", "Liquid Themes", "AJAX Cart Drawers"
];

const services = [
  {
    title: "Custom Shopify Themes",
    desc: "Coding lightweight templates from scratch using clean Liquid and Tailwind CSS. No visual page builders.",
    icon: Code,
    preview: () => (
      <div className="w-full p-4 bg-gray-light rounded-xl border border-gray-border space-y-2 text-[10px] text-charcoal-light font-medium text-left">
        <div className="flex items-center gap-1">
          <span className="text-shopify-forest font-bold">&lt;header&gt;</span>
          <span className="text-charcoal truncate">Logo, Navigation, Search</span>
        </div>
        <div className="flex items-center gap-1 pl-3">
          <span className="text-indigo-600 font-bold">&#123;&#123;</span>
          <span className="text-charcoal font-bold">product.title</span>
          <span className="text-indigo-600 font-bold">&#125;&#125;</span>
        </div>
        <div className="flex items-center gap-1">
          <span className="text-shopify-forest font-bold">&lt;/header&gt;</span>
  ...
  },
  {
    ...
    desc: "Purging app residues, lazy-loading media, deferring scripts, and setting high fetch priorities to hit 90+ speeds.",
    icon: Zap,
    preview: () => (
      <div className="w-full p-4 bg-gray-light rounded-xl border border-gray-border flex items-center justify-between">
        <div className="space-y-1 text-left">
          <span className="text-[10px] font-extrabold text-charcoal">Mobile Speed Index</span>
          <span className="text-[8px] text-charcoal-light block">LCP Render Time</span>
        </div>
  ...
  },
  {
    ...
    desc: "Database migrations from WooCommerce or custom frameworks with full order history log transfers.",
    icon: ShieldCheck,
    preview: () => (
  ...
  {
    title: "Custom Sections & Customizer",
    desc: "Program customizable schema sections that let store owners edit lookbooks and grids natively without code.",
    icon: Layers,
    preview: () => (
      <div className="w-full p-4 bg-gray-light rounded-xl border border-gray-border text-left space-y-1.5">
        <span className="text-[9px] font-extrabold text-charcoal block">Shopify Customizer Settings</span>
...
const shopifyFeatures = [
  {
    ...
    desc: "Fixed conversion bar that stays visible on mobile as customers scroll reviews, increasing checkout entry rates.",
    mock: (color: string) => (
      <div className="w-full h-9 border border-gray-border bg-white rounded-lg flex items-center justify-between px-3 shadow-sm">
        <span className="text-[8px] font-bold text-charcoal truncate">Oak Lounge Sofa</span>
  ...
  {
    title: "Instant Predictive Search",
    desc: "AJAX-driven search bar rendering product thumbnail matches immediately as users type keywords.",
    mock: () => (
      <div className="w-full space-y-1.5 text-left">
        <div className="w-full h-7 border border-gray-border rounded-lg px-2 flex items-center gap-1.5 bg-white text-[8px] text-charcoal-light font-bold">
          <span>Search "trench"...</span>
        </div>
        <div className="p-1.5 rounded-lg border border-gray-border bg-white space-y-1">
          <div className="flex items-center gap-2">
            <span className="text-xs">🧥</span>
            <span className="text-[7px] font-bold text-charcoal">Heritage Wool Trench</span>
          </div>
        </div>
      </div>
    )
  ...
  {
    title: "Custom Variant Swatches",
    desc: "Replace standard selector dropdowns with color and fabric circles that switch product graphics immediately.",
    mock: () => (
      <div className="flex items-center gap-2.5">
        <span className="w-5 h-5 rounded-full border-2 border-charcoal bg-stone-800" />
        <span className="w-5 h-5 rounded-full border border-gray-border bg-stone-300" />
        <span className="w-5 h-5 rounded-full border border-gray-border bg-orange-200" />
      </div>
    )
  },
  {
    title: "Ajax Drawer Carts",
    desc: "Sliding carts enabling shoppers to edit counts, choice warranties, and checkout without reloading pages.",
    mock: (color: string) => (
      <div className="w-[125px] ml-auto h-16 border-l border-gray-border bg-white p-2.5 flex flex-col justify-between shadow-sm rounded-l-lg text-left">
        <span className="text-[7px] font-extrabold text-charcoal">Shopping Cart (1)</span>
  ...
  return (
    <>
      ...
      <main className="flex-grow pt-20 overflow-x-hidden text-charcoal bg-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-center">
              ...
              <div className="lg:col-span-5 flex justify-center w-full order-first lg:order-none relative">
                ...
                >
                  ...
                  >
                    <span className="text-[10px] font-black text-shopify-forest">🛍️ Shopify 2.0</span>
                  </motion.div>

                  {/* Floating tag 2: Liquid */}
                  <motion.div
                    animate={{ y: [0, 8, 0], x: [0, -4, 0] }}
                  ...
                  >
                    <span className="text-[10px] font-black text-shopify-forest">💧 Liquid Custom Code</span>
                  </motion.div>

                  {/* Floating tag 3: Speed */}
                  <motion.div
                    animate={{ y: [0, -10, 0] }}
                  ...
                  >
                    <span className="text-[10px] font-black text-amber-600">⚡ Speed (98%)</span>
                  </motion.div>
                  ...
                  >
                    <span className="text-[10px] font-black text-shopify-forest">📈 Conversion Focused</span>
                  </motion.div>
                  ...
                  <div className="relative w-full h-full rounded-3xl overflow-hidden border border-gray-border shadow-xl bg-white select-none">
                    <img
                      src="/profile.jpg"
                      alt="Muhammad Ahtisham Saingal Profile"
                    ...
                    <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between text-white">
                      <div className="flex flex-col text-left">
                        <span className="text-sm font-extrabold font-heading tracking-tight">M. Ahtisham Saingal</span>
                        <span className="text-[10px] text-shopify-green font-bold uppercase tracking-wider">Shopify Architect</span>
                      </div>
              ...
              <div className="lg:col-span-7 flex flex-col items-start text-left space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  >
                    I build fast, mobile-first Shopify stores with custom Liquid sections, clean theme architecture, conversion-focused layouts, and optimized performance.
                  </motion.p>
                </div>
        ...
        {/* --- LOGO MARQUEE --- */}
        <section className="py-6.5 bg-gray-bg border-b border-gray-border overflow-hidden select-none">
          <Marquee direction="left" speed="slow">
            {marqueeLogos.map((logo, idx) => (
              <span
                key={idx}
                className="text-base sm:text-xl font-heading font-black tracking-tight text-charcoal/20 hover:text-shopify-forest transition-colors duration-200 px-6.5"
              >
                {logo}
              </span>
            ))}
          ...
          <div className="custom-container space-y-24">
            <div className="text-center space-y-3.5 max-w-2xl mx-auto">
              ...
              <p className="text-charcoal-light text-xs sm:text-sm font-semibold max-w-xl mx-auto leading-relaxed">
                Real custom storefront redesigns and styling configurations. Look at the desktop and mobile screen layouts.
              </p>
            </div>
        ...
        <section className="py-16 bg-white border-b border-gray-border overflow-hidden select-none space-y-6">
          ...
          <Marquee direction="right" speed="slow">
            {["Represent", "Gymshark", "Rare Beauty", "Burrow", "Taylor Stitch", "Nomad", "Great Jones", "MVMT", "Mejuri"].map((brand, idx) => (
              <span
                key={idx}
                className="text-base sm:text-lg font-heading font-black text-charcoal/15 px-8 hover:text-shopify-forest transition-colors"
              >
                ⚡ {brand} Storefront Optimized
              </span>
            ))}
          </Marquee>
        </section>
        ...
        <section id="workflow" className="py-24 sm:py-32 scroll-mt-24 relative bg-gray-bg/40 border-b border-gray-border">
          <div className="custom-container space-y-16">
            <div className="text-center space-y-3.5 max-w-2xl mx-auto">
              ...
              <h2 className="font-heading font-extrabold text-3xl sm:text-5xl text-charcoal tracking-tight">
                My Shopify Development Process
              </h2>
              <p className="text-charcoal-light text-xs sm:text-sm font-semibold max-w-xl mx-auto leading-relaxed">
                How I take Shopify stores from concept to launch with pixel-perfect precision and optimized conversions.
              </p>
            </div>
        ...
        <section id="services" className="py-24 sm:py-32 scroll-mt-24 relative bg-white border-b border-gray-border">
          ...
          <div className="custom-container space-y-16">
            <div className="text-center space-y-3.5 max-w-2xl mx-auto">
              ...
              <p className="text-charcoal-light text-xs sm:text-sm font-semibold max-w-xl mx-auto leading-relaxed">
                Coding custom template components that increase order values and page loading speeds.
              </p>
            </div>
          ...
          <div className="custom-container max-w-4xl text-left space-y-6">
            <div className="flex flex-col sm:flex-row items-center gap-6">
              <div className="w-20 h-20 rounded-2xl overflow-hidden border border-gray-border shadow-sm relative flex-shrink-0">
                <img src="/profile.jpg" alt="Muhammad Ahtisham Saingal" className="object-cover w-full h-full" />
              </div>
              <div className="space-y-2">
                ...
                <p className="text-charcoal-light text-xs sm:text-sm leading-relaxed max-w-xl font-semibold">
                  Dedicated software developer specializing in custom Liquid template layouts. Coding custom swatches, slides menus, and AJAX dynamic drawers to improve transaction entries.
                </p>
              </div>
            </div>
            <div className="pt-4 border-t border-gray-border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-[9px] text-charcoal-light font-extrabold uppercase tracking-wider">
              <span>COMSATS University Lahore — BS Software Engineering (2023 - 2027)</span>
              <span>Available for direct developer contracts</span>
            </div>
          </div>
        </section>
        ...
        <section id="capabilities" className="py-24 sm:py-32 scroll-mt-24 bg-white border-b border-gray-border relative">
          ...
          <div className="custom-container space-y-16">
            <div className="text-center space-y-3.5 max-w-2xl mx-auto">
              ...
              <h2 className="font-heading font-extrabold text-3xl sm:text-5xl text-charcoal tracking-tight">
                Shopify Feature Sandbox
              </h2>
              <p className="text-charcoal-light text-xs sm:text-sm font-semibold max-w-xl mx-auto leading-relaxed">
                Check out interactive mocks of high-conversion elements programmed directly with Liquid.
              </p>
            </div>
            ...
            <div className="text-center text-xs text-charcoal-light font-black uppercase tracking-wider">
              And more: Subscriptions, Custom Product Videos, Wishlists, Mega Menus, Predictive Search, Metaobjects & Metafields.
            </div>
          </div>
        </section>
              ...
              <div className="lg:col-span-5 space-y-8 text-left text-charcoal">
                <div className="space-y-4">
                  ...
                  <p className="text-charcoal-light text-xs sm:text-sm leading-relaxed font-bold">
                    Submit your Shopify store details and conversion metrics to receive a personalized speed and performance blueprint.
                  </p>
                </div>
                ...
                <div className="space-y-4 text-xs font-semibold">
                  ...
                  <div className="space-y-2.5">
                    <p className="flex items-center gap-2.5">
                      ...
                      ahtishamsaingal786@gmail.com
                    </p>
                    <p className="flex items-center gap-2.5">
                      <span className="w-6 h-6 rounded bg-gray-bg border border-gray-border flex items-center justify-center text-xs shadow-sm">💬</span>
                      +92 345 9106532 (WhatsApp Line)
                    </p>
                  </div>
                </div>
                ...
                <div className="p-5 rounded-2xl bg-gray-bg border border-gray-border text-[11px] text-charcoal-light leading-relaxed font-semibold">
                  ...
                  I work without agency markups or delegates. You get senior-level code, immediate WhatsApp support, and themes compiled natively on Shopify servers.
                </div>
        ...
        <div className="fixed bottom-0 left-0 right-0 z-30 lg:hidden px-4 py-3.5 bg-white/95 border-t border-gray-border backdrop-blur flex items-center justify-between shadow-lg">
          <div className="flex flex-col text-left">
            <span className="text-[10px] text-shopify-forest font-extrabold uppercase tracking-wider">Ahtisham Saingal</span>
            <span className="text-[8px] text-charcoal-light font-semibold">Shopify Expert</span>
          </div>
          <div className="flex items-center gap-2">
            <a
              href="https://wa.me/923459106532"
