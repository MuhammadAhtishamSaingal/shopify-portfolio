          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-charcoal-light text-xs max-w-sm mx-auto leading-relaxed">
                I will review your storefront details and email you a speed blueprint within 12 hours.
              </p>
            </div>
            <button
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="space-y-1.5">
                <label htmlFor="storeUrl" className="text-[10px] font-bold text-charcoal uppercase tracking-wider block">
                  Current Shopify URL <span className="opacity-60 font-medium">(Optional)</span>
                </label>
                <input
                  type="text"
                  id="storeUrl"
              ...
              <div className="space-y-1.5">
                ...
                >
                  <option value="redesign">Shopify Custom Theme Redesign</option>
                  <option value="setup">New Store Setup (0 to 1)</option>
                  <option value="liquid">Custom Liquid Sections & Code</option>
                  <option value="speed">Performance Optimization (90+ Speed)</option>
                  <option value="apps">Custom App & API Integrations</option>
                </select>
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                placeholder="Share details about your storefront, average traffic, and custom features you want to code..."
