    ...
    <footer className="border-t border-gray-border bg-[#FAFAFA] pt-20 pb-12 relative overflow-hidden text-charcoal">
      <div className="custom-container relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-5 text-left">
            ...
            <p className="text-charcoal-light text-xs leading-relaxed max-w-xs font-semibold">
              Senior Shopify Architect building blazing fast, custom theme configurations and custom Liquid code to scale DTC store conversions.
            </p>
            <div className="flex items-center gap-2 pt-1">
              <a
                href="https://www.linkedin.com/in/muhammad-ahtisham-saingal-447718260"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://github.com/MuhammadAhtishamSaingal"
                target="_blank"
                rel="noreferrer"
                className="w-9 h-9 rounded-xl bg-white border border-gray-border flex items-center justify-center text-charcoal hover:bg-shopify-forest hover:text-white transition-all shadow-sm"
                aria-label="GitHub"
              ...
              <a
                href="https://www.instagram.com/ahtisham.shopify/"
                target="_blank"
                rel="noreferrer"
          ...
          <div className="space-y-5 text-left md:pl-8">
            ...
            <ul className="space-y-3 text-xs font-bold">
              {[
                ...
                { name: "Theme Services", id: "services" },
                { name: "Feature Sandbox", id: "capabilities" },
          ...
          <div className="space-y-5 text-left">
            ...
            <ul className="space-y-3 text-xs font-bold text-charcoal-light">
              <li>
                <span className="hover:text-charcoal transition-colors">Custom Theme Design</span>
              </li>
              <li>
                <span className="hover:text-charcoal transition-colors">Shopify Speed Optimization</span>
              </li>
              <li>
                <span className="hover:text-charcoal transition-colors">Custom Liquid & AJAX Drawers</span>
              </li>
              <li>
                <span className="hover:text-charcoal transition-colors">eCommerce System Migrations</span>
              </li>
              <li>
                <span className="hover:text-charcoal transition-colors">Checkout Extensibility (OS 2.0)</span>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-6 text-left">
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-xs font-bold text-charcoal-light">
                <li className="flex items-center gap-2.5">
                  ...
                  <a href="mailto:ahtishamsaingal786@gmail.com" className="hover:text-shopify-forest transition-colors">
                    ahtishamsaingal786@gmail.com
                  </a>
                </li>
                <li className="flex items-center gap-2.5">
                  <Phone className="w-3.5 h-3.5 text-shopify-forest" />
                  <a href="tel:+923459106532" className="hover:text-shopify-forest transition-colors">
                    +92 345 9106532
                  </a>
                </li>
                <li className="flex items-center gap-2.5">
            ...
            <div className="flex gap-2 pt-1.5">
              <div className="px-3 py-1.5 rounded-lg bg-white border border-gray-border flex items-center gap-1.5 shadow-sm">
                ...
                <span className="text-[8px] font-black text-charcoal uppercase tracking-wider">Shopify Partner</span>
              </div>
              <div className="px-3 py-1.5 rounded-lg bg-white border border-gray-border flex items-center gap-1.5 shadow-sm">
                <div className="w-1.5 h-1.5 rounded-full bg-[#95BF47]" />
                <span className="text-[8px] font-black text-charcoal uppercase tracking-wider">Liquid Developer</span>
              </div>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-gray-border flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px] text-charcoal-light font-bold uppercase tracking-wider">
          <p>© {new Date().getFullYear()} M. Ahtisham Saingal. All Rights Reserved.</p>
